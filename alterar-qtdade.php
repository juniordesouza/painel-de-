...
<head>
    ...
    <title>Alterar quantidade do produto</title>
    ...
    <div class="formulario">
      ...
      <?php
        ...
        if(isset($_POST['confirmar-valor'])){
          ...
          $valorTotal = $valorAntigo + $novoValor;

          $sql2 = "UPDATE tabela1 SET qtdat ='$valorTotal' WHERE idcode ='$id'";
